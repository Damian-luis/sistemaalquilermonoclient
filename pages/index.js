...
import { Typography, Button, TextField, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Backdrop, CircularProgress } from '@mui/material';
import PersonIcon from '@mui/icons-material/Person';
import { useAuthHandlers } from '../hooks/useAuthHandlers';
import { useModalHandlers } from '../hooks/useModalHandlers';
import { useState } from 'react';
export default function Home() {
  const { handleSubmit, handleSubmitAdmin, loading } = useAuthHandlers();
  const { open, openAdmin, handleClickOpen, handleClose, handleClickOpenAdmin, handleClickCloseAdmin } = useModalHandlers();
            ...
            <div style={{ gap: "10px" }}>
              ...
              <Dialog
                ...
                PaperProps={{
                  ...
                  onSubmit: (event) => {
                    event.preventDefault();
                    handleSubmitAdmin(usernameAdmin, passwordAdmin);
                  },
                }}
              >
                <DialogTitle>Admin</DialogTitle>
